...
//                 setColorList(rows);
//                 setFilteredColor(rows);
//             } else {
//                 setError("Failed to load IMF Color data");
//             }
//         } catch (err) {
...
//     }, [searchTerm, activeFilter, colorList]);
...
//     // ✅ Next cCode generator
//     const getNextCode = () => {
//         if (!colorList || colorList.length === 0) return "001";

//         const codes = colorList
...
//                     <h3>{editMode === "edit" ? "Edit Color" : "Add New Color"}</h3>
...
//                                         ? "No color records match your search criteria"
