...
//   const tableName = "HRMSAllowanceType";
...
//         method: "POST",
//         body: JSON.stringify({ tableName, currentOffcode }),
//       });

//       if (data.success && (data.data || data.rows)) {
//         const rows = data.data || data.rows;
//         setAllowanceTypes(rows);
//         setFilteredAllowanceTypes(rows);
//       } else {
//         setError("Failed to load allowance type data");
//       }
//     } catch (err) {
...
//           (key) =>
//             at[key] &&
//             at[key].toString().toLowerCase().includes(searchTerm.toLowerCase())
//         )
//       );
//     }
...
//   }, [searchTerm, activeFilter, allowanceTypes]);
...
//   const getNextCode = () => {
//     if (!allowanceTypes || allowanceTypes.length === 0) return "001";

//     const codes = allowanceTypes
...
//     setFormData({
//       Code: allowanceType.Code || allowanceType.CODE || "",
//       Name: allowanceType.Name || allowanceType.NAME || "",
//       IsActive:
//         allowanceType.IsActive === true ||
//         allowanceType.IsActive === "true" ||
//         allowanceType.IsActive === 1 ||
//         allowanceType.IsActive === "1" ||
//         allowanceType.ACTIVE === true ||
//         allowanceType.ACTIVE === 1,
//       isEmployeeGL:
//         allowanceType.isEmployeeGL === true ||
//         allowanceType.isEmployeeGL === "true" ||
//         allowanceType.isEmployeeGL === 1 ||
//         allowanceType.isEmployeeGL === "1" ||
//         allowanceType.ISEMPLOYEEGL === true ||
//         allowanceType.ISEMPLOYEEGL === 1 ||
//         false,
//       IsDisable:
//         allowanceType.IsDisable === true ||
//         allowanceType.IsDisable === "true" ||
//         allowanceType.IsDisable === 1 ||
//         allowanceType.IsDisable === "1" ||
//         allowanceType.ISDISABLE === true ||
//         allowanceType.ISDISABLE === 1 ||
//         false
...
//         <h2>Allowance Type Management</h2>
//         <div className="loading-spinner"></div>
//         <p>Loading allowance types...</p>
//       </div>
//     );
//   }
...
//           <h3>{editMode === "edit" ? "Edit Allowance Type" : "Add New Allowance Type"}</h3>
...
//                       <div className="list-cell">{at.Code || at.CODE}</div>
//                       <div className="list-cell">{at.Name || at.NAME}</div>
...
//                       </div>
//                       <div className="list-cell center">
//                         <span className={`status-badge ${isDisabled ? 'active' : 'inactive'}`}>
//                           {isDisabled ? 'Yes' : 'No'}
//                         </span>
//                       </div> */}
