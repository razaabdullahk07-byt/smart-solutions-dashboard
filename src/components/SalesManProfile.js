        ...
        <section className="detail-panel">
            <div className="detail-header">
                <div className="header-content">
                    <h1>{isNewMode ? 'Create New Salesman' : `${SaleManName || 'Salesman'} Details`}</h1>
...
const SalesmanProfile = () => {
    ...
    const { data: salesmen, lookupData, isLoading: isDataLoading, error, refetch } = useDataService();
                        ...
                        <div className="profile-list">
                            {filteredSalesmen.map(salesman => (
                                ...
                                >
                                    ...
                                    {normalizeValue(salesman.phone1) && (
                                        <div className="profile-phone">{normalizeValue(salesman.phone1)}</div>
                                    )}
                                </div>
                            ))}
                        </div>
