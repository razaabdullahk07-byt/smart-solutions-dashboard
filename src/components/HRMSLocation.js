...
//           (key) =>
//             location[key] &&
//             location[key].toString().toLowerCase().includes(searchTerm.toLowerCase())
//         )
//       );
//     }
...
//   const getNextCode = () => {
//     if (!locations || locations.length === 0) return "001";
...
//           <h3>{editMode === "edit" ? "Edit Location" : "Add New Location"}</h3>
...
//               <div className="header-cell">Location Code</div>
//               <div className="header-cell">Location Name</div>
...
//                       <div className="list-cell">{location.Code}</div>
//                       <div className="list-cell">{location.Name}</div>
//                       <div className="list-cell center">
//                         <span className={`status-badge ${isActive ? 'active' : 'inactive'}`}>
//                           {isActive ? 'Active' : 'Inactive'}
//                         </span>
//                       </div>
//                       <div className="list-cell">{location.offcode}</div>
