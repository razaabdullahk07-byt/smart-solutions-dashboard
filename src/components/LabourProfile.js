...
const useLabourDataService = () => {
    ...
    return { labourData, lookupData, isLoading, error, refetch: loadAllData };
};
...
const LabourProfileForm = ({
    ...
    // Get labour control account from branch data
        ...
        <section className="detail-panel">
            <div className="detail-header">
                <div className="header-content">
                    <h1>{isNewMode ? 'Create New Labour' : `${LabourName || 'Labour'} Profile`}</h1>
            ...
            <div className="detail-body">
                {/* Basic Information */}
                <CollapsibleSection title="Basic Information" icon={<Icon.User />} defaultExpanded={true}>
                        ...
                        <div className="form-group">
                            ...
                            {labourControlAccount && (
                                <div className="field-info">
                                    Control Account: {labourControlAccount}
                                </div>
                            )}
                        </div>
...
const LabourProfile = () => {
    ...
    const { labourData, lookupData, isLoading: isDataLoading, error, refetch } = useLabourDataService();
    ...
    // Generate labour code starting from 0000000001
                                    ...
                                    <div className="profile-main">
                                        ...
                                        <div className="profile-meta">
                                            ...
                                            <span className="labour-type">
                                                ...
                                                {labour.LabourType === '03' && 'Temporary'}
                                            </span>
                                            <span className="payment-method">
                                                {labour.paymentmethod === '1' && 'Advance Party'}
                                                {labour.paymentmethod === '2' && 'Payment Against Delivery'}
                                                {labour.paymentmethod === '3' && 'Credit'}
                                            </span>
                                        </div>
                                    </div>
                                    {normalizeValue(labour.phone1) && (
                                        <div className="profile-phone">{normalizeValue(labour.phone1)}</div>
                                    )}
